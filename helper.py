...
class Helper:
    ...
    def insert_terms(self, post_id: int, terms: str, taxonomy: str):
        terms = [x.strip() for x in terms.split(",")]
        for term in terms:
            term_insert_slug = slugify(term)
        ...
        try:
            ...
            tvseries_postmeta_data = [
                ...
                (
                    post_id,
                    "episode_run_time",
                    post_data["episode_run_time"].replace("m", ""),
                ),
            ...
            movie_postmeta_data = [
                ...
                (
                    post_id,
                    "Runtime",
                    f"{post_data['episode_run_time'].replace('m', '')} min",
                ),
            ]
    ...
    def insert_episode(self, episode_data: dict):
        ...
        episode_number = int(episode_data["episode_number"]) - 1
        ...
        self.insert_postmeta(postmeta_data, "postmeta")
